package com.dl.dlexerciseandroid.ui.spring;
...
import com.dl.dlexerciseandroid.utility.utility.UrlUtils;
...
public class ConsumingRestfulWebServiceFragment extends Fragment implements View.OnClickListener,
    ...
    private void sendRequestToSpringServer() {
        ...
        String uri = UrlUtils.buildUrlString(Utils.URI_SPRING_WEB_SERVICE, map);
