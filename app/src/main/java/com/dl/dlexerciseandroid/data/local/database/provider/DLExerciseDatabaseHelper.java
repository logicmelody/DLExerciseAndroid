package com.dl.dlexerciseandroid.data.local.database.provider;
...
import com.dl.dlexerciseandroid.data.local.database.dbscheme.MessageTable;
import com.dl.dlexerciseandroid.data.local.database.dbscheme.TaskTable;
