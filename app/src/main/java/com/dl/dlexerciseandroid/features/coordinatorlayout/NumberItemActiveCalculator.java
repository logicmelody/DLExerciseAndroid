...
import com.volokh.danylo.visibility_utils.calculator.BaseItemsVisibilityCalculator;
...
/**
 * Created by logicmelody on 2017/11/29.
 */

public class NumberItemActiveCalculator extends BaseItemsVisibilityCalculator {
    ...
    private final SingleListViewItemActiveCalculator.Callback<ListItem> mCallback;
    ...
    private ListItemData mPreviousItem = null;

    public NumberItemActiveCalculator(SingleListViewItemActiveCalculator.Callback<ListItem> callback, List<? extends ListItem> listItems) {
        mCallback = callback;
        mListItems = listItems;
    }

    /**
     * Methods of this callback will be called when new active item is found {@link SingleListViewItemActiveCalculator.Callback#activateNewCurrentItem(ListItem, View, int)}
     * or when there is no active item {@link SingleListViewItemActiveCalculator.Callback#deactivateCurrentItem(ListItem, View, int)} - this might happen when user scrolls really fast
     */
    ...
    private void setCurrentItem(ListItemData newCurrentItem) {
        ...
        if (mPreviousItem != null) {
            mCallback.deactivateCurrentItem(mListItems.get(mPreviousItem.getIndex()),
                                            mPreviousItem.getView(),
                                            mPreviousItem.getIndex());
        }
